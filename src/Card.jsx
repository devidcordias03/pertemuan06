function Card() {
    return (
        <>
            <div class="flex justify-center items-center h-screen w-full bg-gradient-to-r from-blue-500 to-gray-600">
                <div class="w-1/2 bg-green rounded-lg shadow-2xl p-8 m-4">
